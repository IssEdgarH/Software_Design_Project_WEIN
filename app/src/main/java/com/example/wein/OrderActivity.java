...
import com.example.wein.databinding.ActivityOrderBinding;
...
public class OrderActivity extends AppCompatActivity {
    ...
    private Button orderToHomeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOrderBinding = ActivityOrderBinding.inflate(getLayoutInflater());
        View view = mOrderBinding.getRoot();
        setContentView(view);
        ...
        orderToHomeButton = mOrderBinding.orderToHomeButton;

        orderToHomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static Intent getIntent(Context applicationContext) {
        return new Intent(applicationContext, OrderActivity.class);
    }
}